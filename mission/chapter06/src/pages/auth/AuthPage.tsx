    ...
    <div className="min-h-screen bg-[#111111] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl bg-[#1e1e1e] p-6 shadow-xl border border-white/10">
          ...
          {errorMessage ? <p className="mb-3 rounded-lg bg-red-500/10 px-3 py-2 text-sm text-red-400">{errorMessage}</p> : null}
          {successMessage ? <p className="mb-3 rounded-lg bg-emerald-500/10 px-3 py-2 text-sm text-emerald-400">{successMessage}</p> : null}
          ...
          {isSigninPage ? (
            <form onSubmit={handleSigninSubmit} className="grid gap-3">
              ...
              {isAuthenticated() && (
                <button
                  type="button"
                  className="h-11 rounded-xl border border-white/20 bg-transparent text-sm font-semibold text-slate-400 transition hover:bg-white/10"
